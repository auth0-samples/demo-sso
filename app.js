$('document').ready(function() {
  ...
  var killSessionBtn = $('#btn-kill-session');
  ...
  killSessionBtn.click(killSession);
  ...
  function logout() {
    ...
    window.location.href = 'https://'+AUTH0_DOMAIN+'/v2/logout?returnTo='+encodeURIComponent(origin);
  }
